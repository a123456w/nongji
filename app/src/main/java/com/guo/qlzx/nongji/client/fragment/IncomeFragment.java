...
public class IncomeFragment extends BaseFragment {
    ...
    public View getContentView(FrameLayout frameLayout) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_income_fragment, frameLayout, false);
    ...
    public void initView() {
        ...
        butCom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getCommitAddLabelDate(new PreferencesHelper(mContext).getToken(), id, money, ToolUtil.getTimeStamp(tvRili.getText().toString(), "yyyy-MM-dd"), 2,comment);

                Log.d("ExpendFragment", tvRili.getText().toString() + "++++" + ToolUtil.getTimeStamp(tvRili.getText().toString(), "yyyy-MM-dd HH:mm"));
                getCommitAddLabelDate(new PreferencesHelper(mContext).getToken(), id, money, ToolUtil.getTimeStamp(tvRili.getText().toString(), "yyyy-MM-dd HH"), 2,comment);
    ...
    @Override
    public void getData() {
        getLabelDate(new PreferencesHelper(mContext).getToken(), 2);
    }
    ...
    private void inputTitleDialog() {
        ...
        com.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getAddLabelDate(new PreferencesHelper(getActivity()).getToken(), 2, inputName);
...
//        builder.setView(inputServer).setPositiveButton(getString(R.string.commit_name),
