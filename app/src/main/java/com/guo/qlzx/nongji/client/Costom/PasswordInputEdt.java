...
public class PasswordInputEdt extends android.support.v7.widget.AppCompatEditText {
    ...
    private onWordLessThanSixClick lessThanSixClick;
    /**
     * 是否密文显示
     */
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == 67 && text.length() != 0) {
            ...
            if (lessThanSixClick!=null){
                lessThanSixClick.onClick(text);
            }
            invalidate();
        }
    ...
    public void setLessThanSixClick(onWordLessThanSixClick lessThanSixClick) {
        this.lessThanSixClick = lessThanSixClick;
    }

    public interface onWordLessThanSixClick{
