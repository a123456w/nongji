...
//        mNpRight.setDividerColor(Color.GREEN);
    ...
    * */
     ...
     * @param timeMillis
     */
    private void updateLeftValue(long timeMillis,Boolean b) {
        ...
        if (mCurrentType == TYPE_PICK_DATE) {
            ...
            for (int i = 0; i < DATA_SIZE; i++) {
                ...
                str[i] = sdf.format(cal.getTimeInMillis())+"年";
    ...
    private void updateMiddleValue(long timeMillis) {
        ...
        if (mCurrentType == TYPE_PICK_DATE) {
            ...
            for (int i = 0; i < DATA_SIZE; i++) {
                ...
                str[i] = sdf.format(cal.getTimeInMillis())+"月";
            }
        } else {
    ...
    public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
        ...
        if (picker == mNpLeft) {
            ...
            updateLeftValue(calendar.getTimeInMillis(),true);
