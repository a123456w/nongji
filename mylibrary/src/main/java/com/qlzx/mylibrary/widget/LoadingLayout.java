...
public class LoadingLayout extends FrameLayout {
    ...
    private static int emptyTextSize = 14;
    ...
    private void build() {
        ...
        loadingPage.setBackgroundColor(getColor(backgroundColor));
        errorPage.setBackgroundColor(getColor(backgroundColor));
        emptyPage.setBackgroundColor(getColor(backgroundColor));
        networkPage.setBackgroundColor(getColor(backgroundColor));
        ...
        emptyText.setTextSize(emptyTextSize);
        networkText.setTextSize(tipTextSize);

        errorText.setTextColor(getColor(tipTextColor));
        emptyText.setTextColor(getColor(tipTextColor));
        networkText.setTextColor(getColor(tipTextColor));
        ...
        errorReloadBtn.setTextColor(getColor(buttonTextColor));
        networkReloadBtn.setTextColor(getColor(buttonTextColor));
    ...
    public LoadingLayout setReloadButtonTextColor(@ColorRes int id) {
        ...
        errorReloadBtn.setTextColor(getColor(id));
        networkReloadBtn.setTextSize(getColor(id));
        return this;
    }
    ...
    public static class Config {
        ...
        public Config setAllEmptyTextSize(int sp){
            emptyTextSize = sp;
            return mConfig;
        }
