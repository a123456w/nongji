...
import com.cretin.www.externalmaputilslibrary.utils.GPSUtil;
...
//                    double[] doubles = GPSUtil.bd09_To_Gcj02(Double.parseDouble(latitude), Double.parseDouble(longitude));
//                    //高德
                    if (type == TYPE_MAPVIEW_WITH_TIPS) {
                        openGaodeMarkerMap(activity, latitude + "", longitude + "", appName, title);
                    } else if (type == TYPE_MAPVIEW_DIRECTION) {
                        openGaodeRouteMap(activity, latitude + "", longitude + "", title, dLongitude, dLatitude, dName, appName);
                    } else if (type == TYPE_MAPVIEW_NAVI) {
...
//                    //高德
//                    if (type == TYPE_MAPVIEW_WITH_TIPS) {
//                        openGaodeMarkerMap(activity, doubles[0] + "", doubles[1] + "", appName, title);
//                    } else if (type == TYPE_MAPVIEW_DIRECTION) {
//                        openGaodeRouteMap(activity, doubles[0] + "", doubles[1] + "", title, dLongitude, dLatitude, dName, appName);
//                    } else if (type == TYPE_MAPVIEW_NAVI) {
//                        openGaodeNaviMap(activity, appName, title, doubles[0] + "", doubles[1] + "");
//                    }
                }
            }
        }, showGaode, showBaidu);
